        ...
        <div class="furisodeContent">
            ...
            <?php  
                ...
                $args = array( 
                    ...
                    'meta_query'  => array(
                        'relation'      => 'AND',
                        array( 'key'     => 'ranking_color', 'value'   => $color, 'compare' => 'LIKE' ),
                        array( 'key'     => 'ranking_patern', 'value'   => $pattern, 'compare' => 'LIKE' ),
                        array( 'key'     => 'ranking_type', 'value'   => $type, 'compare' => 'LIKE' ),
                        array( 'key'     => 'title_shop', 'value'   => $title , 'compare' => 'LIKE' ),
                     ),
                    // 's' => $_GET['s']  
                );
