...
<head>
    ...
    <link href="{{$base_url}}/css/subscribe-better.css" rel="stylesheet">
    <link href="{{$base_url}}/css/main.css" rel="stylesheet">
    <link id="preset" rel="stylesheet" type="text/css" href="{{$base_url}}/css/presets/preset1.">
...
<div id="main-wrapper" class="homepage">
        ...
        <div class="navbar" role="banner">
            <div class="container">
                <a class="secondary-logo" href="index.html">
                    <img class="img-responsive" src="{{$base_url}}/images/presets/preset1/logo.png" alt="logo">
                </a>
            </div>
            <div class="topbar">
                <div class="container">
                    <div id="topbar" class="navbar-header">
                        <a class="navbar-brand" href="index.html">
                            <img class="main-logo img-responsive" src="{{$base_url}}/images/presets/preset1/logo.png" alt="logo">
                        </a>
                        <div id="topbar-right">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/4.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/2.jpg" alt="" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/6.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/3.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/5.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/technology/6.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/technology/5.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/technology/4.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/technology/3.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                ...
                                <div class="top-user-form">
                                    <form id="top-login" role="form">
                                        <div class="input-group" id="top-login-username">
                                            <span class="input-group-addon"><img src="{{$base_url}}/images/others/user-icon.png" alt="" /></span>
                                            <input type="text" class="form-control" placeholder="Username" required="">
                                        </div>
                                        <div class="input-group" id="top-login-password">
                                            <span class="input-group-addon"><img src="{{$base_url}}/images/others/password-icon.png" alt="" /></span>
    ...
    <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div id="home-slider">
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/1.jpg" alt="" />
                                        </div>
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/7.jpg" alt="" />
                                        </div>
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/13.jpg" alt="" />
                                        </div>
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/12.jpg" alt="" />
                                        </div>
                                        <div class="catagory world"><a href="#">World</a></div>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/14.jpg" alt="" />
                                        </div>
                                        <div class="catagory sports"><a href="#">Sports</a></div>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/10.jpg" alt="" />
                                        </div>
                                        <div class="catagory entertainment"><a href="#">Entertainment</a></div>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/11.jpg" alt="" />
                                        </div>
                                        <div class="catagory world"><a href="#">World</a></div>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/8.jpg" alt="" />
                                        </div>
                                        <div class="catagory sports"><a href="#">Sports</a></div>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="post feature-post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <img class="img-responsive" src="{{$base_url}}/images/post/slider/9.jpg" alt="" />
                                        </div>
                                        <div class="catagory entertainment"><a href="#">Entertainment</a></div>
                                    </div>
                                    <div class="post-content">
                        ...
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{$base_url}}/images/post/slider/2.jpg" alt="" />
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{$base_url}}/images/post/slider/3.jpg" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{$base_url}}/images/post/slider/5.jpg" alt="" />
                                    </div>
                                    <div class="catagory entertainment"><a href="#">Entertainment</a></div>
                                </div>
                                <div class="post-content">
                        ...
                        <div class="col-sm-4">
                            <div class="post feature-post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <img class="img-responsive" src="{{$base_url}}/images/post/slider/6.jpg" alt="" />
                                    </div>
                ...
                <div class="col-md-3 visible-md visible-lg">
                    <div class="add featured-add">
                        <a href="#"><img class="img-responsive" src="{{$base_url}}/images/post/add/add1.jpg" alt="" /></a>
                    </div>
                </div><!--/#add-->
            </div>
        </div><!--/.section-->
        ...
        <div class="section add inner-add">
            <a href="#"><img class="img-responsive" src="{{$base_url}}/images/post/add/add2.jpg" alt="" /></a>
        </div><!--/.section-->
            ...
            <div class="latest-news-wrapper">
                ...
                <div id="latest-news">
                    <div class="post medium-post">
                        <div class="entry-header">
                            <div class="entry-thumbnail">
                                <img class="img-responsive" src="{{$base_url}}/images/post/1.jpg" alt="" />
                            </div>
                            <div class="catagory politics"><span><a href="#">Politics</a></span></div>
                        </div>
                        <div class="post-content">
                    ...
                    <div class="post medium-post">
                        <div class="entry-header">
                            <div class="entry-thumbnail">
                                <img class="img-responsive" src="{{$base_url}}/images/post/9.jpg" alt="" />
                            </div>
                            <div class="catagory sports"><span><a href="#">Sports</a></span></div>
                        </div>
                        <div class="post-content">
                    ...
                    <div class="post medium-post">
                        <div class="entry-header">
                            <div class="entry-thumbnail">
                                <img class="img-responsive" src="{{$base_url}}/images/post/8.jpg" alt="" />
                            </div>
                            <div class="catagory politics"><span><a href="#">Politics</a></span></div>
                        </div>
                        <div class="post-content">
                    ...
                    <div class="post medium-post">
                        <div class="entry-header">
                            <div class="entry-thumbnail">
                                <img class="img-responsive" src="{{$base_url}}/images/post/10.jpg" alt="" />
                            </div>
                            <div class="catagory entertainment"><span><a href="#">Entertainment</a></span></div>
                        </div>
                        <div class="post-content">
            ...
            <div class="row">
                                ...
                                <div class="left-content">
                                    <div class="section world-news">
                                        ...
                                        <div class="post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <img class="img-responsive" src="{{$base_url}}/images/post/w1.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-sm-12">
                                                <div class="post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/t1.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="post small-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/t2.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                                ...
                                                <div class="post small-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/t3.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                    ...
                                    <div class="section add inner-add">
                                        <a href="#"><img class="img-responsive" src="{{$base_url}}/images/post/add/add4.jpg" alt="" /></a>
                                    </div><!--/.section add-->
                                        ...
                                        <div id="photo-gallery" class="carousel slide carousel-fade post" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/1.jpg" alt="" /></a>
                                                    <h2><a href="#">No one can agree on how a dog is supposed to wear human pants</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/2.jpg" alt="" /></a>
                                                    <h2><a href="#">500-pound elephant seal causes traffic jam while repeatedly</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/3.jpg" alt="" /></a>
                                                    <h2><a href="#">I rode a Metroboard electric skateboard 30 miles around Manhattan</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/4.jpg" alt="" /></a>
                                                    <h2><a href="#">The super creepy side of the Internet of Things and smart homes</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/5.jpg" alt="" /></a>
                                                    <h2><a href="#">Mirum est notare quam littera gothica, quam nunc putamus parum claram</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/6.jpg" alt="" /></a>
                                                    <h2><a href="#">Someone has calculated the total cost of saving Matt Damon</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/7.jpg" alt="" /></a>
                                                    <h2><a href="#">Wet wedding: Yorkshire couple dons wellies to tie the knot in flooded town</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/8.jpg" alt="" /></a>
                                                    <h2><a href="#">This dog is so stoked for his Christmas present he can hardly stand it</a></h2>
                                                </div>
                                                <div class="item">
                                                    <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/9.jpg" alt="" /></a>
                                            ...
                                            <ol class="gallery-indicators carousel-indicators">
                                                <li data-target="#photo-gallery" data-slide-to="0" class="active">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb1.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="1">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb2.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="2">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb3.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="3">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb4.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="4">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb5.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="5">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb6.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="6">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb7.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="7">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb8.png" alt="" />
                                                </li>
                                                <li data-target="#photo-gallery" data-slide-to="8">
                                                    <img class="img-responsive" src="{{$base_url}}/images/gallery/thumb9.png" alt="" />
                                                </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="post medium-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/lifestyle/1.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                                ...
                                                <div class="post medium-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/lifestyle/2.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                            ...
                                            <div class="col-md-6">
                                                <div class="post medium-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/lifestyle/3.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                                ...
                                                <div class="post medium-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/lifestyle/4.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                    ...
                                    <div class="section health-section">
                                        ...
                                        <div class="health-feature">
                                            <div class="post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <img class="img-responsive" src="{{$base_url}}/images/post/health/1.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="entry-meta">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="post small-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/health/2.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                                ...
                                                <div class="post small-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/health/3.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="post small-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/health/4.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                                ...
                                                <div class="post small-post">
                                                    <div class="entry-header">
                                                        <div class="entry-thumbnail">
                                                            <img class="img-responsive" src="{{$base_url}}/images/post/health/5.jpg" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="post-content">
                                                        <div class="entry-meta">
                                ...
                                <div class="middle-content">
                                    <div class="section sports-section">
                                        ...
                                        <div class="football-result post">
                                            <div class="featured-result">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-4">
                                                        <img class="img-responsive" src="{{$base_url}}/images/gallery/league1.png" alt="" />
                                                    ...
                                                    <div class="col-xs-4">
                                                        <img class="img-responsive" src="{{$base_url}}/images/gallery/league2.png" alt="" />
                                            ...
                                            <div class="league-result">
                                                <ul>
                                                    <li>
                                                        <div class="row">
                                                            <div class="col-xs-4">
                                                                <img class="img-responsive"  src="{{$base_url}}/images/gallery/team1.png" alt="" />
                                                            ...
                                                            <div class="col-xs-4">
                                                                ...
                                                                <img class="img-responsive" src="{{$base_url}}/images/gallery/team2.png" alt="" />
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <img class="img-responsive" src="{{$base_url}}/images/others/sports1.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                        ...
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <img class="img-responsive" src="{{$base_url}}/images/post/sports/2.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                        ...
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <img class="img-responsive" src="{{$base_url}}/images/post/sports/1.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                    ...
                                    <div class="section">
                                        <div class="add inner-add">
                                            <a href="#"><img class="img-responsive" src="{{$base_url}}/images/post/add/add5.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section business-section">
                                        ...
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <img class="img-responsive" src="{{$base_url}}/images/post/business/4.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="post-content">
                                                <div class="entry-meta">
                                        ...
                                        <div class="stock-exchange text-center">
                                            <div class="stock-exchange-zone">
                                                <a href="#"><img class="img-responsive" src="{{$base_url}}/images/gallery/stock.png" alt="" /></a>
                                            </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <div id="sitebar">
                        ...
                        <div class="widget">
                            <div class="add">
                                <a href="#"><img class="img-responsive" src="{{$base_url}}/images/post/add/add3.jpg" alt="" /></a>
                            </div>
                        </div><!--/#widget-->
                            ...
                            <ul class="post-list">
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/1.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                            <div class="video-catagory"><a href="#">World</a></div>
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/2.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                            <div class="video-catagory"><a href="#">Business</a></div>
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/3.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/4.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/5.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/6.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/7.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/rising/8.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <img class="img-responsive" src="{{$base_url}}/images/post/7.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="post-content">
                                            <div class="video-catagory"><a href="#">Business</a></div>
                        ...
                        <div class="widget">
                            <div class="add">
                                <a href="#"><img class="img-responsive" src="{{$base_url}}/images/post/add/add6.jpg" alt="" /></a>
                            </div>
                        </div><!--/#widget-->
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="twitter-feeds">
                        <div class="twitter-feed">
                            <img class="img-responsive" src="{{$base_url}}/images/others/twitter.png" alt="" />
                            <h2>#Newspress</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="widget">
                        ...
                        <ul>
                            <li><a href="{{$base_url}}/images/post/flicker/1.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/1.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/2.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/2.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/3.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/3.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/4.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/4.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/5.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/5.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/6.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/6.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/7.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/7.jpg" alt="" /></a></li>
                            <li><a href="{{$base_url}}/images/post/flicker/8.jpg" class="image-link"><img class="img-responsive" src="{{$base_url}}/images/post/flicker/8.jpg" alt="" /></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4">
...
<footer id="footer">
    <div class="footer-top">
        <div class="container text-center">
            <div class="logo-icon"><img class="img-responsive" src="{{$base_url}}/images/presets/preset1/logo-icon.png" alt="" /></div>
        </div>
    </div>
...
<script type="text/javascript" src="{{$base_url}}/js/jquery.simpleWeather.min.js"></script>
<script type="text/javascript" src="{{$base_url}}/js/jquery.sticky-kit.min.js"></script>
<script type="text/javascript" src="{{$base_url}}/js/jquery.easy-ticker.min.js"></script>
<script type="text/javascript" src="{{$base_url}}/js/jquery.subscribe-better.min.js"></script>
<script type="text/javascript" src="{{$base_url}}/js/main.js"></script>
<script type="text/javascript" src="{{$base_url}}/js/switcher.js"></script>
